  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchDivisions.fulfilled, (state, action) => {
        ...
        let normalizedDivisions = Array.isArray(action.payload) ? action.payload : [];
        
        // If action.payload has a data property that's an array, use that instead
        if (action.payload && Array.isArray(action.payload.data)) {
          normalizedDivisions = action.payload.data;
        }
