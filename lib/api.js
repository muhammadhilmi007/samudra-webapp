...
export const vehicleAPI = {
  ...
  getDeliveryVehicles: (params = {}) => api.get('/vehicles/delivery', { params }),
  
  getAvailableForPickup: (params = {}) => api.get('/vehicles/available-for-pickup', { params }),
  
  getAvailableForLoading: (params = {}) => api.get('/vehicles/available-for-loading', { params }),
