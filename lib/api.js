...
export const vehicleAPI = {
  ...
  update: (id, data) => api.put(`/vehicles/${id}`, data),
  delete: (id) => api.delete(`/vehicles/${id}`),
  uploadPhoto: (id, formData) => api.post(`/vehicles/${id}/upload-photo`, formData, {
    headers: {
      'Content-Type': 'multipart/form-data',
    },
  }),
...
export const truckQueueAPI = {
  getAll: () => api.get('/truck-queues'),
  getById: (id) => api.get(`/truck-queues/${id}`),
  create: (data) => api.post('/truck-queues', data),
  update: (id, data) => api.put(`/truck-queues/${id}`, data),
  delete: (id) => api.delete(`/truck-queues/${id}`),
  updateStatus: (id, status) => api.put(`/truck-queues/${id}/status`, { status }),
  getByBranch: (branchId) => api.get(`/truck-queues/by-branch/${branchId}`),
  getByStatus: (status) => api.get(`/truck-queues/by-status/${status}`),
}
