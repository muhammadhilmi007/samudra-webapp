...
export const pegawaiAPI = {
  ...
  getByBranch: (branchId) => api.get(`/users/by-branch/${branchId}`),
  uploadProfilePicture: (id, formData) => api.put(`/users/${id}/profile-picture`, formData, {
    headers: {
      'Content-Type': 'multipart/form-data',
    },
  }),
  uploadDocument: (id, docType, formData) => api.put(`/users/${id}/document`, formData, {
    headers: {
      'Content-Type': 'multipart/form-data',
    },
    params: { docType },
...
export const customerAPI = {
  ...
  // Ensure this matches the backend route structure
  getSTTs: (customerId) => api.get(`/customers/${customerId}/stts`),
  getCollections: (customerId) => api.get(`/customers/${customerId}/collections`),
  getPickups: (customerId) => api.get(`/customers/${customerId}/pickups`),
}
...
export const vehicleAPI = {
  ...
  getTrucks: () => api.get('/vehicles/trucks'),
  getDeliveryVehicles: () => api.get('/vehicles/delivery'),
  getAvailableForPickup: () => api.get('/vehicles/available-for-pickup'),
  getAvailableForLoading: () => api.get('/vehicles/available-for-loading'),
  create: (data) => api.post('/vehicles', data),
  update: (id, data) => api.put(`/vehicles/${id}`, data),
  delete: (id) => api.delete(`/vehicles/${id}`),
  uploadPhoto: (id, formData, photoType) => api.post(`/vehicles/${id}/upload-photo`, formData, {
    headers: {
      'Content-Type': 'multipart/form-data',
    },
    params: { photoType }, // Add photoType to query params
  }),
  uploadDocument: (id, formData, documentType) => api.post(`/vehicles/${id}/upload-document`, formData, {
    headers: {
      'Content-Type': 'multipart/form-data',
    },
    params: { documentType }, // Add documentType to query params
  }),
}
...
export const pickupRequestAPI = {
  ...
  getByCustomer: (customerId) => api.get(`/pickup-requests/customer/${customerId}`),
  getByBranch: (branchId) => api.get(`/pickup-requests/by-branch/${branchId}`),
  linkToPickup: (id, pickupId) => api.put(`/pickup-requests/${id}/link`, { pickupId }),
}
...
export const truckQueueAPI = {
  ...
  updateStatus: (id, status) => api.put(`/antrian-truck/${id}/status`, { status }),
...
export const loadingAPI = {
  ...
  generateDMB: (id) => api.get(`/loadings/generate-dmb/${id}`, { responseType: 'blob' }),
}
...
export const vehicleQueueAPI = {
  ...
  updateStatus: (id, status) => api.put(`/vehicle-queues/${id}/status`, { status }),
...
export const deliveryAPI = {
  ...
  generateForm: (id) => api.get(`/deliveries/generate-form/${id}`, { responseType: 'blob' }),
}
...
export const collectionAPI = {
  ...
  updateStatus: (id, status) => api.put(`/collections/${id}/status`, { status }),
  addPayment: (id, paymentData) => api.put(`/collections/${id}/payment`, paymentData),
  getByCustomer: (customerId) => api.get(`/collections/by-customer/${customerId}`),
  getByStatus: (status) => api.get(`/collections/by-status/${status}`),
  generateInvoice: (id) => api.get(`/collections/generate-invoice/${id}`, { responseType: 'blob' }),
}
...
export const journalAPI = {
  ...
  updateStatus: (id, status) => api.put(`/finance/journals/${id}/status`, { status }),
  getByDateRange: (startDate, endDate) => api.get('/finance/journals/by-date-range', { params: { startDate, endDate } }),
...
export const cashAPI = {
  ...
  updateBranchTransaction: (id, data) => api.put(`/finance/cash/branch/${id}`, data),
  getBranchTransactionsByBranch: (branchId) => api.get(`/finance/cash/branch/by-branch/${branchId}`),
  getBranchTransactionsByType: (type) => api.get(`/finance/cash/branch/by-type/${type}`),
  getBranchTransactionsByDateRange: (startDate, endDate) => api.get('/finance/cash/branch/by-date-range', { 
  ...
  updateHQTransaction: (id, data) => api.put(`/finance/cash/headquarters/${id}`, data),
  updateHQTransactionStatus: (id, status) => api.put(`/finance/cash/headquarters/${id}/status`, { status }),
  getHQTransactionsByType: (type) => api.get(`/finance/cash/headquarters/by-type/${type}`),
  getHQTransactionsByDateRange: (startDate, endDate) => api.get('/finance/cash/headquarters/by-date-range', { 
    params: { startDate, endDate } 
  }),
}
...
export const bankAPI = {
  ...
  getByBranch: (branchId) => api.get(`/finance/bank-statements/by-branch/${branchId}`),
  getByDateRange: (startDate, endDate) => api.get('/finance/bank-statements/by-date-range', { 
    params: { startDate, endDate } 
  }),
...
export const assetAPI = {
  ...
  calculateDepreciation: (data) => api.post('/assets/calculate-depreciation', data),
...
export const pendingPackagesAPI = {
  ...
  updateStatus: (id, status) => api.put(`/pending-packages/${id}/status`, { status }),
}

// Report API methods
export const reportAPI = {
  getBranchDashboardStats: (branchId) => api.get(`/reports/branches/${branchId}/dashboard`),
  getLoadingManifest: (params) => api.get('/reports/loading-manifest', { params }),
  getSales: (params) => api.get('/reports/sales', { params }),
  getSalesByBranch: (branchId, params) => api.get(`/reports/sales-by-branch/${branchId}`, { params }),
  ...
  getDailyCashByBranch: (branchId, params) => api.get(`/reports/cash-daily/${branchId}`, { params }),
...
export const mobileAPI = {
  ...
  updatePickupRequestStatus: (id, status) => api.put(`/mobile/pickup-requests/${id}/status`, { status }),
  ...
  updateDeliveryStatus: (id, status) => api.put(`/mobile/deliveries/${id}/status`, { status }),
}
