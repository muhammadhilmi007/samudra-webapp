...
import { fetchPickupById, updatePickupStatus } from '@/lib/redux/slices/pickupSlice';
...
import { ArrowLeft, Check, Truck, Calendar, CheckCircle, XCircle, FileText, Clock } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="mb-4">
                  ...
                  <p className="font-medium">{formatDate(pickup.tanggal)}</p>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <p className="font-medium">{pickup.estimasiPengambilan || "-"}</p>
                </div>
              </div>
              <div>
                <div className="mb-4">
                  <p className="text-sm text-gray-500">Pengirim</p>
                  <p className="font-medium">{pickup.pengirim?.nama || "-"}</p>
                </div>
                <div className="mb-4">
                  <p className="text-sm text-gray-500">Alamat Pengambilan</p>
                  <p className="font-medium">{pickup.alamatPengambilan}</p>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <p className="font-medium">{pickup.cabang?.namaCabang || "-"}</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="mb-4">
              ...
              <p className="font-medium">{pickup.kendaraan?.namaKendaraan || "-"}</p>
            </div>
            <div className="mb-4">
              <p className="text-sm text-gray-500">Nomor Polisi</p>
              <p className="font-medium">{pickup.kendaraan?.noPolisi || "-"}</p>
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <p className="font-medium">
                {pickup.waktuBerangkat ? formatDateTime(pickup.waktuBerangkat) : "-"}
              </p>
            </div>
            <div className="mb-4">
              <p className="text-sm text-gray-500">Waktu Kembali</p>
              <p className="font-medium">
                {pickup.waktuPulang ? formatDateTime(pickup.waktuPulang) : "-"}
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">{formatDateTime(pickup.createdAt)}</p>
              </div>
            </div>
            {pickup.waktuBerangkat && (
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{formatDateTime(pickup.waktuBerangkat)}</p>
                </div>
              </div>
            )}
            {pickup.waktuPulang && (
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{formatDateTime(pickup.waktuPulang)}</p>
                </div>
              </div>
            )}
            {pickup.status === "SELESAI" && (
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{formatDateTime(pickup.updatedAt)}</p>
                </div>
              </div>
            )}
            {pickup.status === "CANCELLED" && (
