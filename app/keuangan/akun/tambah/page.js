      ...
      <Card className="mt-4 border-blue-200 bg-blue-50">
        <CardContent className="pt-6">
          <div className="text-blue-700 space-y-2">
            ...
            <p className="text-sm">Berikut adalah format standar kode akun:</p>
            <ul className="text-sm list-disc list-inside">
              <li>1-xxxx: Akun Aset (contoh: 1-1000 Kas)</li>
              <li>2-xxxx: Akun Kewajiban (contoh: 2-1000 Hutang Usaha)</li>
              <li>3-xxxx: Akun Ekuitas (contoh: 3-1000 Modal)</li>
              <li>4-xxxx: Akun Pendapatan (contoh: 4-1000 Pendapatan Jasa)</li>
              <li>5-xxxx: Akun Biaya (contoh: 5-1000 Biaya Operasional)</li>
            </ul>
            <p className="text-sm">Pastikan untuk memilih tipe akun yang sesuai dengan kode akun.</p>
          </div>
        </CardContent>
      </Card>
    </div>
