...
import { fetchAccountById, updateAccount } from '@/lib/redux/slices/financeSlice';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => handleSelectChange('tipeAccount', value)}
                    required
                  >
              ...
              <div>
                <div className="mb-4">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                   account.tipeAccount === 'Pendapatan' ? 'bg-green-100 text-green-800' :
                   account.tipeAccount === 'Biaya' ? 'bg-red-100 text-red-800' :
                   account.tipeAccount === 'Aset' ? 'bg-blue-100 text-blue-800' :
                   account.tipeAccount === 'Kewajiban' ? 'bg-orange-100 text-orange-800' :
                   account.tipeAccount === 'Ekuitas' ? 'bg-purple-100 text-purple-800' : 
